# copied/adapted from https://scipython.com/blog/converting-a-spectrum-to-a-colour/
...
class ColourSystem:
    ...
    path = (Path(__file__).parent / 'cie-cmf.txt').resolve() # get absolute path
    cmf = np.loadtxt(path, usecols=(1,2,3))
